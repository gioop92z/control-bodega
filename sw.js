const CACHE='inventario-v2-20260924-8';
const ASSETS=['./','./index.html','./styles.css','./auto-add.js?v=2.3.0','./app.js?v=2.3.0','./location-scan.js?v=2.3.0','./runtime.js?v=2.3.0','./scanner.js','./manifest.json','./icon.svg'];
