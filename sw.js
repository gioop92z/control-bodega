const CACHE='inventario-v2-20260924-7';
const ASSETS=['./','./index.html','./styles.css','./auto-add.js?v=2.2.0','./app.js?v=2.2.0','./runtime.js?v=2.2.0','./scanner.js','./manifest.json','./icon.svg'];
